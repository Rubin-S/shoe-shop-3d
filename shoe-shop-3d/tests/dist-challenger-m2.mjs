...
var require_lucide_react = __commonJS({
  "node_modules/lucide-react/dist/cjs/lucide-react.js"(exports) {
    ...
    var ChevronDown2 = createLucideIcon("ChevronDown", [
    ...
    var ChevronUp2 = createLucideIcon("ChevronUp", [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]]);
    ...
    var Group2 = createLucideIcon("Group", [
    ...
    var Layers3 = createLucideIcon("Layers", [
      [
        "path",
        {
    ...
    var Palette2 = createLucideIcon("Palette", [
    ...
    var RotateCcw2 = createLucideIcon("RotateCcw", [
      ["path", { d: "M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8", key: "1357e3" }],
      ["path", { d: "M3 3v5h5", key: "1xhq8a" }]
    ]);
    ...
    exports.ChevronDownIcon = ChevronDown2;
    ...
    exports.ChevronUpIcon = ChevronUp2;
    ...
    exports.LucideChevronDown = ChevronDown2;
    ...
    exports.LucideChevronUp = ChevronUp2;
    ...
    exports.LucidePalette = Palette2;
    ...
    exports.LucideRotate3d = Rotate3d;
    exports.LucideRotateCcw = RotateCcw2;
    ...
    exports.Palette = Palette2;
    exports.PaletteIcon = Palette2;
    ...
    exports.RotateCcwIcon = RotateCcw2;
  ...
  static generateRoughnessMap(type, size = 512, baseRoughness = 0.5) {
    ...
    for (let y = 0; y < validSize; y++) {
      for (let x = 0; x < validSize; x++) {
        ...
        let r = baseByte;
        if (type === "leather") {
          const n = Math.sin(x * 0.15) * Math.cos(y * 0.15) * 30;
          r = Math.min(255, Math.max(0, baseByte + Math.round(n)));
        } else if (type === "mesh") {
          const w = Math.sin(x * 0.5) * Math.cos(y * 0.5) * 35;
...
var ProceduralSneakerGenerator = class {
  ...
  static buildUpper(upperMaterial) {
    ...
    const geom = new THREE4.CylinderGeometry(radiusTop, radiusBottom, height, radialSegments, heightSegments, true);
  ...
  static createSneakerAssembly() {
    ...
    const matUpper = PBRMaterialSystem.createMeshPhysicalMaterial("upper", "#141518", {
      roughness: 0.42,
      metalness: 0.05,
      clearcoat: 0.25,
      ...
      sheen: 0.25,
      sheenRoughness: 0.5,
      sheenColor: new THREE4.Color("#FFFFFF"),
      normalScale: new THREE4.Vector2(0.8, 0.8)
    });
    const matSole = PBRMaterialSystem.createMeshPhysicalMaterial("sole", "#D4FF00", {
      roughness: 0.65,
      metalness: 0.1,
      clearcoat: 0.1,
      clearcoatRoughness: 0.2,
    ...
    const matLaces = PBRMaterialSystem.createMeshPhysicalMaterial("laces", "#0A0B0D", {
      roughness: 0.75,
      metalness: 0.02,
      clearcoat: 0,
      sheen: 0.4,
      sheenRoughness: 0.7,
      sheenColor: new THREE4.Color("#E0E0E0"),
...
var CustomizerHUD = ({
  ...
  const currentPreset = externalCurrentPreset !== void 0 ? externalCurrentPreset : store.currentPreset;
  const activeSegment = externalActiveSegment || store.selectedSegment;
  const currentSegmentData = customization[activeSegment] || {
    color: "#1a1a24",
    roughness: 0.5,
    metalness: 0.1,
    clearcoat: 0.1
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "double-bezel-inner p-4 sm:p-5 flex flex-col gap-4 text-white", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-white/5 pb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsx("div", { className: "w-2.5 h-2.5 rounded-full bg-brand-lime animate-pulse shadow-glow-lime" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-brand-lime font-semibold", children: "Lab Atelier" }),
                /* @__PURE__ */ jsx("span", { className: "text-zinc-600 font-mono text-[10px]", children: "\u2022" }),
                /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] tracking-wider text-zinc-400 uppercase", children: "Spec APX-01" })
              ] }),
              /* @__PURE__ */ jsx("h3", { className: "font-display text-sm font-bold tracking-wide text-white uppercase", children: "Customizer HUD" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "px-2.5 py-1 rounded-full bg-white/[0.04] border border-white/10 flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-white/40" }),
              /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] uppercase tracking-wider text-zinc-300", children: currentPreset })
            ] }),
            isCollapsible && /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: "w-7 h-7 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center transition-colors text-zinc-400 hover:text-white",
                title: isCollapsed ? "Expand Customizer" : "Collapse Customizer",
                "aria-label": "Toggle Customizer Visibility",
                children: isCollapsed ? /* @__PURE__ */ jsx(import_lucide_react.ChevronDown, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(import_lucide_react.ChevronUp, { className: "w-4 h-4" })
              }
            )
          ] })
        ] }),
        !isCollapsed && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("span", { className: "font-mono text-[11px] uppercase tracking-wider text-zinc-400 flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx(import_lucide_react.Sparkles, { className: "w-3.5 h-3.5 text-brand-lime" }),
                "Curated Colorways"
              ] }),
              currentPreset === "Custom" && /* @__PURE__ */ jsxs(
                ...
                {
                  type: "button",
                  onClick: () => handlePresetApply("Cyber Phantom"),
                  className: "font-mono text-[10px] text-zinc-500 hover:text-brand-lime flex items-center gap-1 transition-colors",
                  children: [
                    /* @__PURE__ */ jsx(import_lucide_react.RotateCcw, { className: "w-3 h-3" }),
                    "Reset Baseline"
                  ]
                }
              )
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: COLORWAYS_LIST.map((preset) => {
              ...
              return /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `group relative p-2.5 rounded-xl border text-left transition-all duration-200 flex items-center gap-2.5 ${isActive ? "bg-white/10 border-brand-lime shadow-glow-lime" : "bg-white/[0.02] border-white/5 hover:bg-white/[0.06] hover:border-white/15"}`,
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "w-6 h-6 rounded-lg overflow-hidden grid grid-cols-2 grid-rows-2 border border-white/20 flex-shrink-0 shadow-sm", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                      /* @__PURE__ */ jsx(
                        "div",
                        {
                          className: `font-display text-xs font-semibold truncate ${isActive ? "text-brand-lime" : "text-zinc-200 group-hover:text-white"}`,
                          children: preset.name
                        }
                      ),
                      /* @__PURE__ */ jsx("div", { className: "font-mono text-[9px] text-zinc-500 truncate", children: preset.tagline.split("&")[0] })
                    ] }),
                    isActive && /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-brand-lime animate-pulse" })
                  ]
                },
                preset.id
              );
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 pt-1", children: [
            /* @__PURE__ */ jsxs("span", { className: "font-mono text-[11px] uppercase tracking-wider text-zinc-400 flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsx(import_lucide_react.Layers, { className: "w-3.5 h-3.5 text-brand-lime" }),
              "Active Segment"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-1.5 p-1 rounded-xl bg-black/40 border border-white/5", children: SEGMENT_CONFIGS.map((seg) => {
              ...
              return /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `relative py-2 px-1.5 rounded-lg text-center transition-all duration-200 flex flex-col items-center gap-1 ${isActive ? "bg-white/15 text-white font-semibold shadow-inner border border-white/20" : "text-zinc-400 hover:text-zinc-200 hover:bg-white/5"}`,
                  children: [
                    /* @__PURE__ */ jsx(
                      "div",
                      {
                        className: "w-3 h-3 rounded-full border border-white/30 shadow-sm transition-transform group-hover:scale-110",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 pt-1", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("span", { className: "font-mono text-[11px] uppercase tracking-wider text-zinc-400 flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx(import_lucide_react.Palette, { className: "w-3.5 h-3.5 text-brand-lime" }),
                "Colorway Palette"
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "font-mono text-[10px] text-zinc-400 uppercase tracking-widest flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx("span", { className: "text-zinc-500", children: "HEX:" }),
                /* @__PURE__ */ jsx("span", { className: "text-brand-lime font-bold", children: currentSegmentData.color.toUpperCase() })
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-8 gap-2 p-2.5 rounded-xl bg-black/30 border border-white/5", children: CURATED_SWATCHES.map((swatch) => {
              ...
              return /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  className: `relative w-8 h-8 rounded-full border border-white/20 transition-all duration-200 flex items-center justify-center ${isSelected ? "ring-2 ring-brand-lime ring-offset-2 ring-offset-[#0B0C0E] scale-110 shadow-glow-lime" : "hover:scale-105 hover:border-white/40"}`,
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: "h-9 px-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 flex items-center gap-2 transition-colors text-zinc-300 hover:text-white",
              ...
              /* @__PURE__ */ jsxs("form", { onSubmit: handleHexSubmit, className: "flex-1 flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx("div", { className: "relative flex-1", children: /* @__PURE__ */ jsx(
                  "input",
                  {
                    ...
                    maxLength: 7,
                    className: "w-full bg-black/40 border border-white/10 focus:border-brand-lime focus:outline-none rounded-lg px-3 py-1.5 font-mono text-xs text-white placeholder:text-zinc-600 uppercase tracking-widest transition-colors"
                  }
                ) }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    type: "submit",
                    className: "h-9 px-3 rounded-lg bg-white/10 hover:bg-brand-lime hover:text-black border border-white/10 font-mono text-xs font-semibold tracking-wider uppercase transition-all duration-200",
                    children: "Apply"
                  }
                )
              ] })
            ] }),
            hexInputError && /* @__PURE__ */ jsx("span", { className: "text-[10px] font-mono text-brand-crimson tracking-wide", children: hexInputError })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 pt-1 border-t border-white/5 pt-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("span", { className: "font-mono text-[11px] uppercase tracking-wider text-zinc-400 flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx(import_lucide_react.Sliders, { className: "w-3.5 h-3.5 text-brand-lime" }),
                "Material Finish"
              ] }),
              /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] text-zinc-400 uppercase tracking-wider", children: FINISH_PRESETS[activeFinish]?.label || "Bespoke" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2", children: ["matte", "gloss", "metallic", "iridescent"].map((fKey) => {
              ...
              return /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `p-2 rounded-xl border text-center transition-all duration-200 flex flex-col items-center gap-1 ${isSelected ? "bg-brand-lime/10 border-brand-lime text-brand-lime shadow-glow-lime" : "bg-white/[0.03] border-white/5 hover:bg-white/[0.08] hover:border-white/15 text-zinc-400 hover:text-zinc-200"}`,
                  children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "pt-2 border-t border-white/5 flex items-center justify-between text-zinc-500 font-mono text-[10px]", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(import_lucide_react.Eye, { className: "w-3 h-3 text-brand-lime" }),
